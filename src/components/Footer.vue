...
<template>
  <footer class="bg-[#F0F0F0] pt-32 pb-8 px-4 relative mt-32">
    <!-- Newsletter Section (Absolute overlapping top) -->
    <div class="container mx-auto">
      <div
        class="bg-black rounded-[20px] px-6 py-10 md:px-16 md:py-12 flex flex-col md:flex-row items-center justify-between gap-8 absolute -top-24 left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-7xl mx-auto shadow-lg"
      >
        <h2
          class="font-integral font-black text-3xl md:text-4xl text-white max-w-lg leading-tight uppercase"
        >
          Stay upto date about our latest offers
        </h2>
        <div class="w-full md:w-auto flex flex-col gap-3">
          <div class="bg-white rounded-full px-4 py-3 flex items-center gap-2 w-full md:w-80">
            <svg
            ...
            <input
              ...
              class="outline-none text-sm font-satoshi flex-1"
            />
          </div>
          <button
            class="bg-white text-black font-satoshi font-medium rounded-full px-4 py-3 w-full hover:bg-gray-100 transition-colors"
          >
    ...
    <!-- Main Footer Content -->
    <div class="container mx-auto pt-32 lg:pt-16">
      <div
        class="flex flex-col md:flex-row justify-between gap-8 md:gap-12 pb-12 border-b border-black/10"
      >
        <!-- Brand -->
        <div class="md:w-1/3">
          <h3 class="font-integral font-black text-3xl uppercase mb-6">SHOP.CO</h3>
          <p class="font-satoshi text-black/60 text-sm mb-8 max-w-xs">
          ...
          <div class="flex gap-4">
            ...
            <a
              href="#"
              class="w-8 h-8 rounded-full border border-black/20 flex items-center justify-center hover:bg-black hover:text-white transition-colors bg-white"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <a
              href="#"
              class="w-8 h-8 rounded-full border border-black/20 flex items-center justify-center hover:bg-black hover:text-white transition-colors bg-black text-white"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 flex-1">
          <div>
            <h4 class="font-satoshi font-medium text-lg uppercase tracking-widest mb-4">Company</h4>
            <ul class="space-y-3 font-satoshi text-black/60 text-sm">
          ...
          <div>
            <h4 class="font-satoshi font-medium text-lg uppercase tracking-widest mb-4">Help</h4>
            <ul class="space-y-3 font-satoshi text-black/60 text-sm">
          ...
          <div>
            <h4 class="font-satoshi font-medium text-lg uppercase tracking-widest mb-4">FAQ</h4>
            <ul class="space-y-3 font-satoshi text-black/60 text-sm">
          ...
          <div>
            <h4 class="font-satoshi font-medium text-lg uppercase tracking-widest mb-4">
              Resources
            </h4>
            <ul class="space-y-3 font-satoshi text-black/60 text-sm">
      ...
      <div class="py-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <p class="font-satoshi text-black/60 text-sm">Shop.co © 2000-2023, All Rights Reserved</p>
        <div class="flex gap-2">
          <!-- Payment badges (simple visual) -->
          <div
            class="h-8 w-12 bg-white rounded flex items-center justify-center text-[10px] font-bold text-blue-600"
          >
            <svg
              width="33"
              height="11"
          ...
          <div
            class="h-8 w-12 bg-white rounded flex items-center justify-center text-[10px] font-bold text-red-500"
          >
            <svg
              width="26"
              height="16"
          ...
          <div
            class="h-8 w-12 bg-white rounded flex items-center justify-center text-[10px] font-bold text-blue-400"
          >
            <svg
              width="35"
              height="10"
          ...
          <div
            class="h-8 w-12 bg-white rounded flex items-center justify-center text-[10px] font-bold text-black"
          >
            <svg
              width="27"
              height="12"
