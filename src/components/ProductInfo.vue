  ...
  <div class="flex flex-col gap-6">
    ...
    <div>
      ...
      <div class="flex items-center gap-3">
        ...
        <span
          v-if="originalPrice"
          class="font-satoshi font-bold text-3xl text-black/40 line-through"
          >${{ originalPrice }}</span
        >
        <span
          v-if="originalPrice"
          class="font-satoshi font-medium text-sm text-[#FF3333] bg-[#FF3333]/10 px-3 py-1 rounded-full"
    ...
    <p
      class="font-satoshi text-black/60 leading-relaxed text-sm md:text-base border-b border-black/10 pb-6"
    >
      {{ description }}
    </p>
    ...
    <div class="flex items-center gap-4">
      ...
      <button
        class="bg-black text-white rounded-full px-8 py-3.5 flex-1 font-satoshi font-medium hover:bg-black/90 transition-opacity"
      >
        Add to Cart
      </button>
    </div>
